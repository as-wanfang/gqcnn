...
class GraspPlanner(object):
    ...
    def plan_grasp(self, req):
        ...
        print("camera_intrinsics:", camera_intrinsics._K)
        ...
        # print("cropped_camera_intrinsics:", cropped_camera_intrinsics._K)
        ...
        # np.save('/home/wanfang/ros_depth_image.npy', rgbd_image.depth.data)
        ...
        image_state = RgbdImageState(rgbd_image, camera_intrinsics)


        # execute policy
        try:
            return self.execute_policy(image_state, self.grasping_policy, self.grasp_pose_publisher, camera_intrinsics.frame)
    ...
    def execute_policy(self, rgbd_image_state, grasping_policy, grasp_pose_publisher, pose_frame):
        ...
        rospy.loginfo('create GQCNNGrasp')
...
if __name__ == '__main__':
    ...
    print("gripper_width: ", grasping_policy._gripper_width)
